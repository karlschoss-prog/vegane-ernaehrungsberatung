...
const products = [
  ...
  },
  {
    ...
    items: [
      {
        name: "Kids One 1–3",
        desc: "Veganer Multinährstoff von Watson Nutrition speziell für Kinder von 1 bis 3 Jahren. Deckt die wichtigsten Vitamine, Mineralstoffe und Spurenelemente ab, die in dieser Entwicklungsphase besonders gebraucht werden.",
        note: null,
        link: "https://watsonnutrition.de/products/kids-one-1-3?_pos=7&_psq=one&_ss=e&_v=1.0&ref=CHRISTINSCHO",
        linkLabel: "Watson Nutrition – Kids One 1–3 *",
      },
      {
        name: "Smarter Algenöl (EPA, DHA & ARA)",
        desc: "Algenöl-Kapseln von Hopkins Formulations, speziell für Kinder geeignet. Liefert EPA, DHA und ARA aus pflanzlicher Quelle, essenziell für Gehirnentwicklung, Konzentrationsfähigkeit und ein gesundes Immunsystem.",
        note: null,
        link: "https://hopkinsformulations.de/products/smarter-algenol?_fid=3bd33d0dd&_pos=6&_ss=c&ref=CHRISTINSCHO",
        linkLabel: "Hopkins Formulations – Smarter Algenöl *",
      },
      {
        name: "Kinder-Supplemente von Hopkins",
        desc: "Hopkins Formulations bietet Kinder-Supplemente, abgestimmt auf die jeweiligen Altersstufen. Ich empfehle die Produkte als ergänzende Versorgung neben dem Kids One.",
        note: null,
